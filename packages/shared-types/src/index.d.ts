...
export declare const PROFIT_LOSS_PERIODS: readonly ["TODAY", "THIS_WEEK", "THIS_MONTH", "THIS_YEAR", "ALL_TIME"];
...
export declare const FEEDBACK_CATEGORIES: readonly ["App bug", "Sync issue", "Slow performance", "Payment/debtor issue", "Feature request", "Other"];
...
export type PlatformModuleKey = 'SALES' | 'EXPENSES' | 'STOCK' | 'DEBTORS' | 'SAVINGS' | 'SUPPLIERS' | 'CUSTOMERS';
