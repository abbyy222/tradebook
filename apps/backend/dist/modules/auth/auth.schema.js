...
exports.updateSalespersonSchema = exports.createSalespersonSchema = exports.loginSchema = exports.registerSchema = void 0;
...
exports.updateSalespersonSchema = zod_1.z.object({
    phoneNumber: zod_1.z
        .string()
        .regex(/^\+?[0-9]{10,15}$/, 'Invalid phone number'),
    name: zod_1.z.string().min(2).max(100),
